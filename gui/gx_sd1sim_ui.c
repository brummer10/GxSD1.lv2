...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_sd1simUI* ui = (gx_sd1simUI*)arg->ui;
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    set_expose_func(GX_SD1_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    set_expose_func(GX_SD1_PAINT_BOX(ui->pf1box),"frame_expose");
