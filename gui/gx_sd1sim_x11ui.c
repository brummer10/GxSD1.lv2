...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[1] = { -16.0, -16.0, -20.0, 4.0, 0.4, 110, 60, 61, 61, false,"LEVEL", KNOB, LEVEL};
	ui->controls[2] = { 400.0, 400.0, 100.0, 1000.0, 10.3, 180, 60, 61, 61, false,"TONE", KNOB, TONE};
	ui->controls[3] = { 0.5, 0.5, 0.0, 1.0, 0.01, 250, 60, 61, 61, false,"DRIVE", KNOB, DRIVE};
