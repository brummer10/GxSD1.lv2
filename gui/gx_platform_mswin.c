...
void gx_gui_create_window_and_surface(gx_sd1simUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_sd1simUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_sd1simUI *ui) {
	...
	UnregisterClass(TEXT("gx_sd1simUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_sd1simUI *ui = (gx_sd1simUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
